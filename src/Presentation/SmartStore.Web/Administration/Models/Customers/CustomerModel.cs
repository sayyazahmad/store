...
namespace SmartStore.Admin.Models.Customers
{
    ...
    public class CustomerModel : TabbableModel
    {
        public CustomerModel()
        {
            ...
            AvailableMembershipPlans = new List<SelectListItem>();
        }
        ...
        [SmartResourceDisplayName("Admin.Customers.Customers.Fields.MembershipPlan")]
        public int MembershipPlanId { get; set; }
        public IList<SelectListItem> AvailableMembershipPlans { get; set; }

        [SmartResourceDisplayName("Admin.Customers.Customers.Fields.IsAgent")]
        ...
        [SmartResourceDisplayName("Admin.Customers.Customers.Fields.BankName")]
        public string BankName { get; set; }

        [SmartResourceDisplayName("Admin.Customers.Customers.Fields.IBAN")]
