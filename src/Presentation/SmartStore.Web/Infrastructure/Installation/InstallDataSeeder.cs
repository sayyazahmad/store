...
namespace SmartStore.Web.Infrastructure.Installation
{
	public partial class InstallDataSeeder : IDataSeeder<SmartObjectContext>
    {
        ...
        private void PopulateMembershipPlans()
        {
            SaveRange(_data.MembershipPlans().Where(x => x != null));
        }
		...
		protected ILocalizationService LocalizationService
		{
			get
			{
				if (_locService == null)
				{
					...
					var storeService = new StoreService(new EfRepository<Store>(_ctx), NullEventPublisher.Instance, new SecuritySettings(), new EfRepository<StoreBannerImage>(_ctx));
