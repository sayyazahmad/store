...
namespace SmartStore.Web.Infrastructure
{
	public class DefaultBundles : IBundleProvider
	{
		public void RegisterBundles(BundleCollection bundles)
		{
            ...
            /* agent File Manager
			-----------------------------------------------------*/
            var roxy1 = "~/Agent/Content/filemanager/";
            var scriptBundle1 = new CustomScriptBundle("~/bundles/roxyfm").Include(
                roxy1 + "js/jquery-2.1.1.min.js",
                roxy1 + "js/jquery-ui-1.10.4.custom.min.js",
                roxy1 + "js/filetypes.js",
                roxy1 + "js/custom.js",
                roxy1 + "js/main.js",
                roxy1 + "js/utils.js",
                roxy1 + "js/file.js",
                roxy1 + "js/directory.js",
                roxy1 + "js/jquery-dateFormat.min.js");
            scriptBundle1.Orderer = new NullOrderer();
