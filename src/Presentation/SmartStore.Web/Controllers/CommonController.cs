...
namespace SmartStore.Web.Controllers
{
	public partial class CommonController : PublicControllerBase
    {
        ...
        public ActionResult ShopBar()
        {
			...
			var isRegistered = isAdmin || customer.IsRegistered() || customer.IsAgent();
            ...
            var model = new ShopBarModel
            {
                ...
                DisplayAgentLink = _services.Permissions.Authorize(StandardPermissionProvider.AccessAgentPanel),
