...
namespace SmartStore.Web.Framework.Controllers
{
    ...
    [AgentThemedAttribute(Order = -1)]
    public abstract class AgentControllerBase : SmartController
    {
        /// <summary>
        ...
        protected override void Initialize(RequestContext requestContext)
        {
            ...
            {
                EngineContext.Current.Resolve<IWorkContext>().IsAgent = true;
            }
        ...
        {
            return RedirectToAction("AccessDenied", "Security", new { pageUrl = this.Request.RawUrl, area = "Agent" });
        }
        ...
        {
            return PartialView("~/Agent/Views/Security/AccessDenied.cshtml");
        }
    }
}
