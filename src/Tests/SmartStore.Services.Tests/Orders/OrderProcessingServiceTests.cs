...
namespace SmartStore.Services.Tests.Orders
{
    ...
    public class OrderProcessingServiceTests : ServiceTest
    {
        ...
        IMembershipPlanService _membershipPlanService;
        IComissionService _comissionService;
        [SetUp]
        public new void SetUp()
        {
            ...
            _membershipPlanService = MockRepository.GenerateMock<IMembershipPlanService>();
            _comissionService = MockRepository.GenerateMock<IComissionService>();
            ...
            _orderProcessingService = new OrderProcessingService(_orderService, _webHelper,
                ...
                _catalogSettings, _membershipPlanService, _comissionService);
        }
