...
namespace SmartStore.Services.Security
{
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManagePaymentRequest = new PermissionRecord { Name = "Admin area. Manage Payment Requests", SystemName = "ManagePaymentRequest", Category = "Configuration" };
        public static readonly PermissionRecord ManageBankUpdateRequest = new PermissionRecord { Name = "Admin area. Manage Bank Update Request", SystemName = "ManageBankUpdateRequest", Category = "Configuration" };
        ...
        public static readonly PermissionRecord AccessAgentPanel = new PermissionRecord { Name = "Access agent area", SystemName = "AccessAgentPanel", Category = "Standard" };
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[] 
            {
                ...
                new DefaultPermissionRecord
                {
                    CustomerRoleSystemName = SystemCustomerRoleNames.Agents,
                    PermissionRecords = new[]
                    {
                        AccessAgentPanel,
