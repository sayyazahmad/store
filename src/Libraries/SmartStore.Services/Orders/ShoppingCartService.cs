...
namespace SmartStore.Services.Orders
{
	public partial class ShoppingCartService : IShoppingCartService
    {
        ...
        public virtual IList<string> UpdateShoppingCartItem(Customer customer, int shoppingCartItemId, int newQuantity, bool resetCheckoutData, decimal price = 0)
        {
			Guard.NotNull(customer, nameof(customer));
            ...
            {
                if (customer.IsAgent && price > 0)
                    shoppingCartItem.CustomerEnteredPrice = price;
