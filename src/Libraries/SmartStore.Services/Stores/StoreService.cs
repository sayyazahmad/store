...
namespace SmartStore.Services.Stores
{
	public partial class StoreService : IStoreService
	{
        ...
        private readonly IRepository<StoreBannerImage> _storeBannerImageRepository;
        ...
        public IList<StoreBannerImage> GetStoreBannerImagesByStoreId(int storeId)
        {
            return _storeBannerImageRepository.Get(x => x.StoreId == storeId).ToList();
        }

        public StoreBannerImage GetGetBannerImageIdById(int id)
        {
            return _storeBannerImageRepository.GetById(id);
        }

        public void DeleteBannerImage(int id)
        {
            var entity = _storeBannerImageRepository.GetById(id);
            _storeBannerImageRepository.Delete(entity);
        }
