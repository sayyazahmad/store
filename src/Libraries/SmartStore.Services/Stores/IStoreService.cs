...
namespace SmartStore.Services.Stores
{
	...
	public partial interface IStoreService
	{
        ...
        void InsertStoreBannerImage(StoreBannerImage bannerImage);

        IList<StoreBannerImage> GetStoreBannerImagesByStoreId(int storeId);

        StoreBannerImage GetGetBannerImageIdById(int storeId);
        void DeleteBannerImage(int id);
    }
}