...
namespace SmartStore.Core.Domain.Orders
{
	...
	public partial class Order : BaseEntity, IAuditable, ISoftDeletable
    {
        ...
        private ICollection<Comission> _comissions;
        ...
        /// </summary>
		[DataMember]
        public virtual ICollection<Comission> Comissions
        {
            get { return _comissions ?? (_comissions = new HashSet<Comission>()); }
            protected set { _comissions = value; }
        }
